...
class AdminDashboard(View):
    def get(self, request):
        ...
        orders.total_revenue = Order.objects.all().aggregate(Sum("final_price"))[
            "final_price__sum"
        ]
        ...
        for month in range(1, 13):
            total_final_price = (
                ...
                ).aggregate(total_final_price=Sum("final_price"))["total_final_price"]
                or 0
            )
        ...
        return render(
            request,
            "superuser/admin_dashboard.html",
            {"users": users, "orders": orders, "monthly_data": monthly_data},
        )
...
class AdminBanner(View):
    ...
    def post(self, request):
        ...
        print(img, product)
        Banner.objects.create(image=img, product=product)
...
class AdminCategory(View):
    def get(self, request):
        ...
        return render(
            request, "superuser/admin_category.html", {"categories": categories}
        )
...
class AdminSubCategory(View):
    def get(self, request):
        ...
        return render(
            request,
            "superuser/admin_sub_category.html",
    ...
    def post(self, request):
        ...
        Sub_Category.objects.create(
            name=sub_category_name, image=image, category=category
        )
...
class AdminProduct(View):
    def get(self, request):
        ...
        return render(
            request,
            "superuser/admin_product.html",
            {"brands": brands, "subcategories": subcategories, "products": products},
        )
...
class AdminProductVariants(View):
    def get(self, request, pk):
        ...
        return render(
            request,
            "superuser/admin_product_variant.html",
            {"product": specified_product, "variants": variants},
        )
    ...
    def post(self, request, pk):
        ...
        for image in images:
            ProductVarientImage.objects.create(
                image=image, product_variant=product_variant
            )
...
class AdminCoupons(View):
    def get(self, request):
        ...
        return render(
            request,
            "superuser/admin_coupon.html",
            {"coupons": coupons, "current_date": current_date},
        )
...
class AdminOrderDetails(View):
    def get(self, request, pk):
        ...
        return render(
            request, "superuser/admin_order_details.html", {"order_items": order_items}
        )
