...
#     path('color/', views.AdminColors.as_view(), name='admin_color'),
    ...
    path('subcategory/', views.AdminSubCategory.as_view(),
         name='admin_sub_category'),
    path('product/', views.AdminProduct.as_view(), name='admin_product'),
    path('product/<str:pk>/', views.AdminProductVariants.as_view(),
